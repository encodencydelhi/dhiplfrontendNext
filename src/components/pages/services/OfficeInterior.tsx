...
const OfficeInteriorPage = () => {
    const [selectedImage, setSelectedImage] = useState<any>(null);
    const { data, portfolioGalleryImages } = useServiceDetail("Office Interior");
    ...
    return (
        <div className="min-h-screen bg-white overflow-x-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 py-16 md:py-20">
                <ServiceContentSection serviceName="Office Interior" />
                {portfolioGalleryImages && portfolioGalleryImages.length > 0 && (
                    <RecentWorkSection
                        galleryItems={portfolioGalleryImages}
                        onImageClick={setSelectedImage}
                        viewAllLink="/portfolio/office-interior/office-portfolio"
                    />
                )}
                <Location category="Office Interior" />
            </div>
            <Footer />
            <AnimatePresence>
                {selectedImage && (
...
export default OfficeInteriorPage;
