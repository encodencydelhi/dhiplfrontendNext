...
import OfficeChairView from "@/components/pages/portfolio/office-interior/OfficeChair";
...
export async function generateMetadata(): Promise<Metadata> {
  const [pageSeo, data] = await Promise.all([
    fetchPageSeo("/portfolio/office-interior/office-chairs-images"),
    fetchServiceDetail("Office Interior"),
  ]);
  return buildMetadata(mergePageSeo(pageSeo, data), undefined, "/portfolio/office-interior/office-chairs-images");
}
